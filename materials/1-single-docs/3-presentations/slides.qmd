...
:::{layout-ncol="2"}
Essays on Functionality

List of Options YAML keys
:::
...
```scss {code-line-numbers="1|3-4|6-7|9-11|13-16"}
/*-- scss:defaults --*/
...
:::{style="text-align: center"}
{{< fa arrow-rotate-left >}} Return to [Live Code](#fa-bolt-live-code)(#fa-bolt-live-code) {{< fa arrow-rotate-left >}}
:::
